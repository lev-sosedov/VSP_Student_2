...
class Branch(Base):
    ...
    branch_address_id = Column(Integer, ForeignKey("branch_addresses.id"), nullable=False)  # адрес филиала id
    ...
    branch_address = relationship("BranchAddress", back_populates="branch")  # связь с адресом филиала
