...
class EducationPlan(Base):
    ...
    modules = relationship("EducationPlanModule", back_populates="education_plan") # связь с модулем
    groups = relationship("Group", back_populates="education_plan") # связь с группы
