...
from academic_service.messaging.consumer import RabbitConsumer
from academic_service.messaging.config import (
    ACADEMIC_QUEUE,
    ACADEMIC_ROUTING_KEYS,
)

from academic_service.events.handlers import handlers
