...
from academic_service.schemas.schemas_branch_address import (BranchAddressCreate, BranchAddressUpdate)
...
class BranchService:
    ...
    # получить филиалы по стране
    async def get_by_country(self, country: str):
        return await self.branch_repo.get_by_country(country)
