...
class DirectionService:
    ...
    async def create_direction(self, data: DirectionCreate):
        ...
        direction = Direction(name=data.name, description=data.description)

        return await self.repo.create(direction)
    ...
    async def filter_directions(self, filters: DirectionFilter):
