...
class GroupService:
    ...
    async def update_group(self, group_id: int, data: GroupUpdate):
        ...
        return await self.repo.update(group_id, update_data)
    ...
    async def patch_group(self, group_id: int, data: GroupPatch):
        ...
        return await self.repo.update(group_id, patch_data)
    ...
    async def activate_group(self, group_id: int):
        ...
        return await self.repo.update(group_id, {"is_active": True})
    ...
    # восстановить группу
    async def restore_group(self, group_id: int):
        group = await self.repo.get_by_id(group_id)
    ...
    async def safe_delete_group(self, group_id: int):
        group = await self.repo.get_by_id(group_id)
    ...
    async def get_by_plan(self, education_plan_id: int):
        ...
        return await self.repo.get_by_plan(education_plan_id)
